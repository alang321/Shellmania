...
class splittingbomb:
    ...
    def __init__(self, pos, dir, velocity, terrain, wind, entities, player, m=1.0, color=pygame.color.THECOLORS["red"], coeffrest=0.8, instance=5):
        if instance > 0:
            cretae new bomb same attributes or something
