...
class settingsscene:
    ...
    settingsitems = [[[0, "key", "Move left", "Left"], [0, "key", "Move right", "Right"], [0, "key", "Next item", "Next"], [0, "key", "Previous item", "Previous"], [0, "key", "Fire", "Fire"]],
                     [[1, "float", "Initial fuel in seconds", "Initial fuel", [0, 999]], [1, "float", "Maximum wind strength", "Wind strength", [0, 100]], [1, "float", "Maximum turret angle", "Max turret angle", [0, 180]], [1, "float", "Player speed", "Player speed", [0, 9999]], [1, "float", "Fullpower shot charging time", "Fullpower shot time", [0, 60]], [1, "float", "Relative shooting power", "Shot power", [0, 100]]],
